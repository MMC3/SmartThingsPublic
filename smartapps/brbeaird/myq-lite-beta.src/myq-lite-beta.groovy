...
def prefSensor7() {	   
	def titleText = "Contact Sensor for Door 7 (" + state.data[doors[6]].name + ")"
    return dynamicPage(name: "prefSensor7",  title: "Optional Sensors and Push Buttons", nextPage:"summary", install:false, uninstall:true) {
        section(titleText){			
